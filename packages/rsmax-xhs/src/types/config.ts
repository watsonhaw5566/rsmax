/** 页面配置文件 */
// reference: https://miniapp.xiaohongshu.com/docs?path=/docs/guide/miniConfigPage
...
/** 全局配置文件 */
// reference: https://miniapp.xiaohongshu.com/docs?path=/docs/guide/miniConfigGlobal
export interface AppConfig {
  ...
  /**
   * 需要跳转的小程序列表，相关 api 见xhs.navigateToMiniProgram
   * 1.5.0
   */
