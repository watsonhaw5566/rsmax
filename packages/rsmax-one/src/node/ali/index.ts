...
import hostComponents from '../../hostComponents/ali/node';

const TPL_DEFAULT_ROOT = path.join(__dirname, '../../../templates', 'ali', 'default');
const TPL_STATIC_ROOT = path.join(__dirname, '../../../templates', 'ali', 'static');
