...
import * as channelCard from './ChannelCard/node';
import * as channelInvite from './ChannelInvite/node';
...
import * as draggable from './Draggable/node';
import * as dragTarget from './DragTarget/node';
...
import * as shortVideo from './ShortVideo/node';
...
import * as textRecognizer from './TextRecognizer/node';
import * as video from './Video/node';
import * as view from './View/node';
import * as voipChat from './VoipChat/node';
...
hostComponents.set('channel-card', channelCard);
hostComponents.set('channel-invite', channelInvite);
...
hostComponents.set('draggable', draggable);
hostComponents.set('drag-target', dragTarget);
...
hostComponents.set('short-video', shortVideo);
...
hostComponents.set('text-recognizer', textRecognizer);
...
hostComponents.set('voip-chat', voipChat);
