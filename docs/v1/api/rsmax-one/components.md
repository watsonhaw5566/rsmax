...
| onTap          | ((event: [TapEvent](/v1/api/rsmax-one/event#tapevent))) => void | 点击事件                                                     |
...
| className | string                                                         | 节点样式类        |
| style     | React.CssProperties                                            | 节点 inline style |
| onSubmit  | ((event: [FormEvent](/v1/api/rsmax-one/event#formevent))) => void | 提交事件          |
| onReset   | ((event: [FormEvent](/v1/api/rsmax-one/event#formevent))) => void | 重置表单事件      |
...
| onLoad        | ((event: [ImageLoadEvent](/v1/api/rsmax-one/event#imageloadevent))) => void                                                                                                         | 当图片加入完毕时触发 |
| onError       | ((event: [ImageErrorEvent](/v1/api/rsmax-one/event#imageerrorevent))) => void                                                                                                       | 当错误发生时触发     |
| onTap         | ((event: [TapEvent](/v1/api/rsmax-one/event#tapevent))) => void                                                                                                                     | 点击事件             |
| onTouchStart  | ((event: [TouchStartEvent](/v1/api/rsmax-one/event#touchstartevent))) => void                                                                                                       | 触碰开始事件         |
| onTouchMove   | ((event: [TouchMoveEvent](/v1/api/rsmax-one/event#touchmoveevent))) => void                                                                                                         | 触碰移动事件         |
| onTouchEnd    | ((event: [TouchMoveEvent](/v1/api/rsmax-one/event#touchmoveevent))) => void                                                                                                         | 触碰结束事件         |
| onTouchCancel | ((event: [TouchCancelEvent](/v1/api/rsmax-one/event#touchcancelevent))) => void                                                                                                     | 触碰取消事件         |
...
| onInput          | ((event: [InputEvent](/v1/api/rsmax-one/event#inputevent))) => any  | 输入回调事件        |
| onConfirm        | ((event: [InputEvent](/v1/api/rsmax-one/event#inputevent))) => void | 键盘确认回调事件    |
| onFocus          | ((event: [InputEvent](/v1/api/rsmax-one/event#inputevent))) => void | focus 事件          |
| onBlur           | ((event: [InputEvent](/v1/api/rsmax-one/event#inputevent))) => void | blur 事件           |
...
| onTap          | ((event: [TapEvent](/v1/api/rsmax-one/event#tapevent))) => void                 | 点击事件                       |
| onLongTap      | ((event: [TapEvent](/v1/api/rsmax-one/event#tapevent))) => void                 | 长按点击事件                   |
| onTouchStart   | ((event: [TouchStartEvent](/v1/api/rsmax-one/event#touchstartevent))) => void   | 触碰开始事件                   |
| onTouchMove    | ((event: [TouchMoveEvent](/v1/api/rsmax-one/event#touchmoveevent))) => void     | 触碰移动事件                   |
| onTouchEnd     | ((event: [TouchMoveEvent](/v1/api/rsmax-one/event#touchmoveevent))) => void     | 触碰结束事件                   |
| onTouchCancel  | ((event: [TouchCancelEvent](/v1/api/rsmax-one/event#touchcancelevent))) => void | 触碰取消事件                   |
...
| style     | React.CssProperties                                  | 节点 inline style |
| src       | string                                               | 地址              |
| onMessage | (event: [Event](/v1/api/rsmax-one/event#event)) => void | 通信回调          |
